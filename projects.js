...
// Create a triangle geometry for pr-1
...
// Adjust scale according to the div size
...
// Create a scene for pr-2
var scene2 = new THREE.Scene();

// Create a camera for pr-2
var camera2 = new THREE.PerspectiveCamera(75, 1, 0.1, 1000);
camera2.position.z = 5;

// Create a renderer for pr-2
...
// Create a cube geometry for pr-2
...
// Create a scene for pr-3
var scene3 = new THREE.Scene();

// Create a camera for pr-3
var camera3 = new THREE.PerspectiveCamera(75, 1, 0.1, 1000);
camera3.position.z = 5;

// Create a renderer for pr-3
...
// Create a chart geometry for pr-3 (for demonstration purposes, this is a wireframe sphere)
